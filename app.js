...
closeButton.addEventListener('click',exportData);
function startRecording() {
    console.log("recordButton clicked");

    document.getElementById("detailForm").reset();
    document.querySelector("#detailForm").style.display='block';
...
function saveRecording(){
    var ele=document.querySelector('#recordingsList');
    var d = new Date();
    var n = d.getTime();
    ...
    out+=n;
    out += '\r\n';
    document.querySelector("#detailForm").style.display='none';
}
